<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Book_issue.aspx.cs" Inherits="WebApplication1.Book_issue" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
 ...
 <asp:Button ID="Button4" class="btn btn-lg btn-block btn-success" runat="server" Text="Return" OnClick="Button4_Click" />
     ...
     <div class="col-3">
     <asp:Button ID="Button3" runat="server" class="btn btn-lg btn-block btn-success"  Text="Clear" OnClick="Button3_Click" />
     </div>
 </div>
 </div>
 </div>
