<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Member_manage.aspx.cs" Inherits="WebApplication1.Member_manage" %>
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col-6 mx-auto">
                      ...
                      <asp:Button ID="Button1" runat="server" class="btn btn-lg btn-block btn-primary" Text="Clear" OnClick="Button1_Click" />
                          </div>
